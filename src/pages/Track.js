...
function Track() {
  ...
  const [info] = React.useState({
    ...
    Discription: "ใจพัง",
    Diagnote: "เราไม่ได้เป็นอะไรกัน",
    Status: "ซ่อมไม่ได้",
    reportDate: "10/09/2020",
  });
